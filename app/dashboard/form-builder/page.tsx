...
type FieldType = "text" | "dropdown" | "toggle" | "phone" | "number" | "long_text";
...
const FIELD_PALETTE: { type: FieldType; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
...
function SortableFieldRow({
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 text-sm truncate">{field.label || "(no label)"}</span>
      {field.required && (
...
export default function FormBuilderPage() {
  ...
  const selectedField = activeSection?.fields.find((f) => f.id === selectedFieldId) ?? null;
  ...
  return (
    <div className="flex flex-col h-full gap-3 sm:gap-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold tracking-tight">Form Builder</h1>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Button onClick={publish} disabled={saving} className="w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[200px_1fr_280px] gap-3 sm:gap-4 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-2 overflow-y-auto">
          ...
          <div className="mt-4">
            ...
            <Button variant="ghost" size="sm" onClick={addSection} className="w-full mt-1">
