...
import { User, Sun, Moon, Monitor, Lock, CheckCircle, AlertCircle } from "lucide-react";
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Profile & Preferences</h1>
